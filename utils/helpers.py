...
import numpy as np
from utils.dataloaders import (full_path_loader, full_test_loader, CDDloader, LEVIRloader,LEVIRplusloader)
...
def get_loaders(opt):
    ...
    if opt.dataset == 'cdd':
        ...
        train_dataset = LEVIRplusloader(train_full_load, flag='trn', aug=opt.augmentation)
        val_dataset = LEVIRplusloader(val_full_load, flag='val', aug=False)
